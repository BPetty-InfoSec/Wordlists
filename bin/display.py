...
def DisplayMenu():
    ...
    """
    menuOptionsL, menuOptionsR = LoadMenuOptions(
    )  # Load menu options from menuoptions.json
    ClearScreen()                                   # Clear the screen
    # Prints the header (defaults to Main Menu)
    PrintHeader()
...
def PrintLine(optionL, optionR):
    ...
    if optionR:
        ...
        rightOption = ""
    print("|  " + leftOption.ljust(35, " ") +
          " | " + rightOption.ljust(35, " ") + "  |")
...
def ShowWordListItem(listItem):
    ...
    print("| -- Categories: " + categoriesString +
          " " * (77-(len(categoriesString) + 17)) + " |")
